'''
Expand the data structure defined earlier in exercise3a. 
...
The output of your Python script should look as follows (in other words, 
your YAML data structure should yield the following when read by Python). 
...
filename = "/home/zhen/pythoncourse/les7/3b.yml"
